...
/** @typedef {InstanceType<import("./config-dependency")["ConfigDependency"]>} ConfigDependency */
/** @typedef {InstanceType<import("./override-tester")["OverrideTester"]>} OverrideTester */
...
function initPluginMemberMaps(elements, slots) {
    const envMap = slots.envMap = new Map();
    const processorMap = slots.processorMap = new Map();
    const ruleMap = slots.ruleMap = new Map();
